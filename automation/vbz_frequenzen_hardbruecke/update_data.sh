...
curl -L https://data.integ.stadt-zuerich.ch/dataset/vbz_frequenzen_hardbruecke/download/vbz_hardbruecke_frequenzen_${year}.csv --output $DIR/frequenzen_hardbruecke_${year}.csv # integration
