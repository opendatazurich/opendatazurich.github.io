...
start_date = today - timedelta(days=8) # look 3 days back > if error occurs and fixed within 3 days, downtime data will be reincluded
start_date = start_date.strftime("%Y%m%d")
end_date = today + timedelta(days=-6) # some date in the future > will include the latest data
